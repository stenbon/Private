...
Если все цифры подтвердились реальными источниками — ответь ровно: OK

Если хотя бы одна цифра не подтвердилась, выдумана или сильно искажена — перечисли
проблемные места списком, каждая проблема с новой строки, кратко.
...
{text_only[:6000]}"""},
        ...
        if result.upper().startswith("OK"):
            ...
            print("    ⚠️ Фактчек нашёл непроверенные/неверные цифры (пост уйдёт в черновики):")
